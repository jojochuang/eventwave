...
open(my $compilemace, '-|', 'mace-fullcontext/tools/gcc_test/compilemace.pl', '-p', '1', '-b', 'relwithdebinfo') or die "can't open pipe to start compiling mace"; # test all available     gcc versions, relwithdebinfo (-O2 -g) build
